...
func registerSDKWords(r *eng.Registry, client *sdk.ProxyCheckerSDK) {
...
func runOp(client *sdk.ProxyCheckerSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
