// Command ProxyChecker-mcp is an MCP server exposing the ProxyChecker
// SDK as MCP tools.
//
// Two tools are registered:
//
//	ProxyChecker_list  — list records of an entity
//	ProxyChecker_load  — load a single record of an entity
//
