...
function runner.env_override(m)
  local live = runner.getenv("PROXY_CHECKER_TEST_LIVE")
  local override = runner.getenv("PROXY_CHECKER_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("PROXY_CHECKER_TEST_EXPLAIN")
