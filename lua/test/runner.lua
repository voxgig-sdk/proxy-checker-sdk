...
function runner.env_override(m)
  local live = runner.getenv("PROXYCHECKER_TEST_LIVE")
  local override = runner.getenv("PROXYCHECKER_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("PROXYCHECKER_TEST_EXPLAIN")
