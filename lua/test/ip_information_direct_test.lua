...
describe("IpInformationDirect", function()
  it("should direct-load-ip_information", function()
    local setup = ip_information_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-ip_information", setup.live and "live" or "unit")
