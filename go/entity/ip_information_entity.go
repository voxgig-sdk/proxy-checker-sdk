...
import (
	...
	vs "github.com/voxgig-sdk/proxy-checker-sdk/go/utility/struct"
)

type IpInformationEntity struct {
	name    string
	client  *core.ProxyCheckerSDK
...
func NewIpInformationEntity(client *core.ProxyCheckerSDK, entopts map[string]any) *IpInformationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *IpInformationEntity) GetName() string { return e.name }
...
func (e *IpInformationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *IpInformationEntity) Deleted() bool {
	return e.deleted
}


func (e *IpInformationEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewIpInformationEntity(e.client, opts)
}

func (e *IpInformationEntity) Data(args ...any) any {
...
func (e *IpInformationEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an IpInformation; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *IpInformationEntity) DataTyped(data ...IpInformation) IpInformation {
	if len(data) > 0 {
		return typedFrom[IpInformation](e.Data(asMap(data[0])))
	}
	return typedFrom[IpInformation](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through IpInformation (all fields
// optional at the wire level).
func (e *IpInformationEntity) MatchTyped(match ...IpInformation) IpInformation {
	if len(match) > 0 {
		return typedFrom[IpInformation](e.Match(asMap(match[0])))
	}
	return typedFrom[IpInformation](e.Match())
}
...
func (e *IpInformationEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *IpInformationEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// IpInformationLoadMatch and returns an IpInformation. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *IpInformationEntity) LoadTyped(reqmatch IpInformationLoadMatch, ctrl map[string]any) (IpInformation, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return IpInformation{}, err
	}
	return typedFrom[IpInformation](res), nil
}



func (e *IpInformationEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *IpInformationEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *IpInformationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *IpInformationEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *IpInformationEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
