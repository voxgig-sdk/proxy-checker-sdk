...
func NewCheckEntity(client *core.ProxyCheckerSDK, entopts map[string]any) *CheckEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CheckEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// CheckCreateData and returns an Check. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *CheckEntity) CreateTyped(reqdata CheckCreateData, ctrl map[string]any) (Check, error) {
