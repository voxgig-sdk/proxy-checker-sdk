...
const testSeed = `map[string]any{"entity": map[string]any{"check": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ip_information": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
