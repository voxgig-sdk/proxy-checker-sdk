# ProxyChecker SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ProxyCheckerSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ProxyCheckerSDK(...) and ProxyCheckerSDK.test(...) become
#      ProxyCheckerSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "proxychecker_sdk"
_SDK_CLASS = "ProxyCheckerSDK"
