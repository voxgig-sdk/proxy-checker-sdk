...
class ProxyCheckerTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ProxyCheckerTestRunner.getenv("PROXYCHECKER_TEST_LIVE")
        override = ProxyCheckerTestRunner.getenv("PROXYCHECKER_TEST_OVERRIDE")
        ...
        explain = ProxyCheckerTestRunner.getenv("PROXYCHECKER_TEST_EXPLAIN")
