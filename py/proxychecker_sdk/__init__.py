...
from proxychecker_sdk.utility import register

# Load features
from proxychecker_sdk.feature.base_feature import ProxyCheckerBaseFeature
from proxychecker_sdk.features import _has_feature, _make_feature
...
class ProxyCheckerSDK:
    ...
    def get_utility(self):
        return ProxyCheckerUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ProxyCheckerSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Check(self, data=None) -> "CheckEntity":
        ...
        from proxychecker_sdk.entity.check_entity import CheckEntity
        return CheckEntity(self, data)


    def IpInformation(self, data=None) -> "IpInformationEntity":
        """Entity factory: client.IpInformation().list() / client.IpInformation().load({"id": ...})."""
        from proxychecker_sdk.entity.ip_information_entity import IpInformationEntity
        return IpInformationEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "ProxyCheckerSDK":
        if sdkopts is None:
            sdkopts = {}
