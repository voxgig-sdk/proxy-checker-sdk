...
class CheckEntity
  ...
  # @return [Check, Hash] the loaded Check; raises ProxyCheckerError on failure
  ...
  # Create a new Check.
  #
  # @param reqdata [CheckCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Check, Hash] the created Check; raises ProxyCheckerError on failure
