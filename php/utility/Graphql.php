...
// ProxyChecker SDK utility: graphql
//
...
class ProxyCheckerGraphql
{
    ...
    // equivalent.
    public static function body(ProxyCheckerContext $ctx): mixed
    {
    ...
    public static function errors(ProxyCheckerContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
