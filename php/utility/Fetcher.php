...
// ProxyChecker SDK utility: fetcher

class ProxyCheckerFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ProxyCheckerSDK/1.0)';
    ...
    public static function call(ProxyCheckerContext $ctx, string $fullurl, array $fetchdef): array
    {
