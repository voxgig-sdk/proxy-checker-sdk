# ProxyChecker PHP SDK



The PHP SDK for the ProxyChecker API — an entity-oriented client using PHP conventions.
...
```
php/
├── proxychecker_sdk.php          -- Main SDK class
...
The main class (`proxychecker_sdk.php`) exports the SDK class
