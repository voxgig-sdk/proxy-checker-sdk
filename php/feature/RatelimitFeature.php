...
// ProxyChecker SDK ratelimit feature
...
class ProxyCheckerRatelimitFeature extends ProxyCheckerBaseFeature
{
    ...
    private function _acquire(ProxyCheckerContext $ctx): void
    {
    ...
    private function _track(ProxyCheckerContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
