...
// ProxyChecker SDK debug feature
...
class ProxyCheckerDebugFeature extends ProxyCheckerBaseFeature
{
    ...
    private function _finish(ProxyCheckerContext $ctx, bool $ok): void
    {
