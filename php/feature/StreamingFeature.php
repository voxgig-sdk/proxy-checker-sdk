...
// ProxyChecker SDK streaming feature
...
class ProxyCheckerStreamingFeature extends ProxyCheckerBaseFeature
{
    ...
    private function _iterate(ProxyCheckerResult $result): \Generator
    {
    ...
    private function _streamable(ProxyCheckerContext $ctx): bool
    {
