...
class ProxyCheckerRbacFeature extends ProxyCheckerBaseFeature
{
    ...
    private function _required(ProxyCheckerContext $ctx): ?string
    {
    ...
    private function _reject(ProxyCheckerContext $ctx, string $required): void
    {
    ...
    private function _track(ProxyCheckerContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
