...
// ProxyChecker SDK audit feature
...
class ProxyCheckerAuditFeature extends ProxyCheckerBaseFeature
{
    ...
    private function _emit(ProxyCheckerContext $ctx, string $outcome): void
    {
