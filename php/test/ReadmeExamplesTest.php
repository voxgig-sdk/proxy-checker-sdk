...
// ProxyChecker SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ProxyCheckerSDK::test)
...
{
    private const SDK_CLASS = 'ProxyCheckerSDK';
    ...
    private const SDK_BASE = 'proxychecker_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../proxychecker_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
