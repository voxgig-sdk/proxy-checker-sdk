...
// ProxyChecker SDK pipeline test
//
...
{
    private static function utility(): ProxyCheckerUtility
    {
        return new ProxyCheckerUtility();
    }
    ...
    private static function ctx(array $over = []): ProxyCheckerContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new ProxyCheckerContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new ProxyCheckerOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof ProxyCheckerError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new ProxyCheckerOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = ProxyCheckerMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new ProxyCheckerOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = ProxyCheckerMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new ProxyCheckerOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = ProxyCheckerMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ProxyCheckerSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = ProxyCheckerMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new ProxyCheckerResponse([]),
            'result' => new ProxyCheckerResult([]),
        ]);
        [, $err] = ProxyCheckerMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new ProxyCheckerSpec([]),
            'response' => null,
            'result' => new ProxyCheckerResult([]),
        ]);
        [, $err] = ProxyCheckerMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new ProxyCheckerSpec(['step' => 's']),
            'response' => new ProxyCheckerResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new ProxyCheckerResult([]),
        ]);
        [, $err] = ProxyCheckerMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new ProxyCheckerSpec(['step' => 's']),
            'response' => new ProxyCheckerResponse(self::resp(200, ['v' => 1])),
            'result' => new ProxyCheckerResult([]),
        ]);
        [, $err] = ProxyCheckerMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new ProxyCheckerSpec(['step' => 's']),
            'response' => new ProxyCheckerResponse(self::resp(200, ['v' => 2])),
            'result' => new ProxyCheckerResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        ProxyCheckerMakeResponse::call($ctx);
    ...
    {
        $preset = new ProxyCheckerResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new ProxyCheckerSpec([]),
            'response' => new ProxyCheckerResponse([]),
            'result' => new ProxyCheckerResult([]),
        ...
        [$got, $err] = ProxyCheckerMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new ProxyCheckerResult([])]);
        [, $err] = ProxyCheckerMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new ProxyCheckerSpec([]), 'result' => null]);
        [, $err] = ProxyCheckerMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ProxyCheckerSpec(['step' => 's']),
            'result' => new ProxyCheckerResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new ProxyCheckerOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ProxyCheckerMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ProxyCheckerSpec(['step' => 's']),
            'result' => new ProxyCheckerResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new ProxyCheckerOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ProxyCheckerMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ProxyCheckerResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new ProxyCheckerSpec([]),
            'result' => new ProxyCheckerResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = ProxyCheckerMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ProxyCheckerMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new ProxyCheckerError('boom', 'boom');
        $utility->fetcher = function (ProxyCheckerContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ProxyCheckerSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = ProxyCheckerMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (ProxyCheckerContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = ProxyCheckerMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(ProxyCheckerResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        ProxyCheckerMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (ProxyCheckerContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ProxyCheckerSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = ProxyCheckerMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new ProxyCheckerResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new ProxyCheckerSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = ProxyCheckerMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = ProxyCheckerMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = ProxyCheckerMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new ProxyCheckerResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, ProxyCheckerDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new ProxyCheckerResult(['ok' => false])]);
        $this->expectException(ProxyCheckerError::class);
        ProxyCheckerDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new ProxyCheckerResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', ProxyCheckerMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        ProxyCheckerMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new ProxyCheckerBaseFeature();
        $b = new ProxyCheckerBaseFeature();
        ProxyCheckerFeatureAdd::call($ctx, $a);
        ProxyCheckerFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): ProxyCheckerBaseFeature
    {
        $f = new ProxyCheckerBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        ProxyCheckerFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): ProxyCheckerContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new ProxyCheckerSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ProxyCheckerPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        ProxyCheckerPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new ProxyCheckerResponse(['headers' => null]),
            'result' => new ProxyCheckerResult([]),
        ]);
        ProxyCheckerResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        ProxyCheckerResultBody::call($ctx);
