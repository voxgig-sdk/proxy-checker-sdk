...
class CheckEntity
{
     ...
     * Create a new Check.
     *
     * @param CheckCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CheckCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Check|array The created Check as an assoc-array at the
     *   SDK boundary; throws ProxyCheckerError on failure (item-5 convention).
     */
