# ProxyChecker SDK utility: make_error
...
def make_error_util(ctx, err):
    ...
    errmsg = ""
    if isinstance(err, ProxyCheckerError):
        errmsg = err.msg
    ...
    msg = "ProxyCheckerSDK: " + opname + ": " + errmsg
    ...
    sdk_err = ProxyCheckerError("", msg, ctx)
