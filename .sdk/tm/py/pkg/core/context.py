...
from projectname_sdk.core.control import ProxyCheckerControl
...
class ProxyCheckerContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, ProxyCheckerSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, ProxyCheckerResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ProxyCheckerResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return ProxyCheckerError(code, msg, self)
