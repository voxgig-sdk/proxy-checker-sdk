...
// ProxyChecker SDK proxy feature
...
class ProxyCheckerProxyFeature extends ProxyCheckerBaseFeature
{
    ...
    public function init(ProxyCheckerContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ProxyCheckerContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
