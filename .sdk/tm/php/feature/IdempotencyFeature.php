...
// ProxyChecker SDK idempotency feature
...
class ProxyCheckerIdempotencyFeature extends ProxyCheckerBaseFeature
{
    ...
    private function _mutating(ProxyCheckerContext $ctx): bool
    {
