...
// ProxyChecker SDK metrics feature
...
class ProxyCheckerMetricsFeature extends ProxyCheckerBaseFeature
{
    ...
    private function _record(ProxyCheckerContext $ctx, bool $ok): void
    {
