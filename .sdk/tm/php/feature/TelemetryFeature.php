...
// ProxyChecker SDK telemetry feature
...
class ProxyCheckerTelemetryFeature extends ProxyCheckerBaseFeature
{
    ...
    private function _close(ProxyCheckerContext $ctx, bool $ok): void
    {
