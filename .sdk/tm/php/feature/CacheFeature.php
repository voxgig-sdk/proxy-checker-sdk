...
// ProxyChecker SDK cache feature
...
class ProxyCheckerCacheFeature extends ProxyCheckerBaseFeature
{
    ...
    private function _through(ProxyCheckerContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
