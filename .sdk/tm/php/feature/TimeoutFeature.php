...
// ProxyChecker SDK timeout feature
...
class ProxyCheckerTimeoutFeature extends ProxyCheckerBaseFeature
{
    ...
    private function _with_timeout(ProxyCheckerContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ProxyCheckerContext $_ctx, float $ms): void
    {
        $client = $this->client;
