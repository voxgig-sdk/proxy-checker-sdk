...
// ProxyChecker SDK clienttrack feature
...
class ProxyCheckerClienttrackFeature extends ProxyCheckerBaseFeature
{
    ...
    public function PostConstruct(ProxyCheckerContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'ProxyChecker-SDK';
