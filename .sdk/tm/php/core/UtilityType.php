...
// ProxyChecker SDK utility type

class ProxyCheckerUtility
{
    ...
    public static function copy(ProxyCheckerUtility $src): ProxyCheckerUtility
    {
        $u = new ProxyCheckerUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
