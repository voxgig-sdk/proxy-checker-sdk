...
// ProxyChecker SDK utility: make_options

class ProxyCheckerMakeOptions
{
    ...
    public static function call(ProxyCheckerContext $ctx): array
    {
        ...
        //
        // `ProxyCheckerSchema::optspec()` is built from the model:
        ...
        $optspec = ProxyCheckerSchema::optspec();
