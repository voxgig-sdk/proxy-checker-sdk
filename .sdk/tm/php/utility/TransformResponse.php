...
// ProxyChecker SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class ProxyCheckerTransformResponse
{
    public static function call(ProxyCheckerContext $ctx): mixed
    {
        ...
        $transform = ProxyCheckerHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
