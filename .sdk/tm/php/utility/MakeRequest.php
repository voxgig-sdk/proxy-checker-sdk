...
// ProxyChecker SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class ProxyCheckerMakeRequest
{
    public static function call(ProxyCheckerContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new ProxyCheckerResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new ProxyCheckerResponse($fetched);
        } else {
