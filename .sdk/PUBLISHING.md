...
|---|---|---|
| `ts/` | @voxgig-sdk/proxy-checker-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/proxy-checker-sdk \
      --repository voxgig-sdk/proxy-checker-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/proxy-checker-sdk` shows it, and
`npm trust revoke @voxgig-sdk/proxy-checker-sdk --id=<id>` removes it.
