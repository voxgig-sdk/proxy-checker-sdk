...
(0, node_test_1.describe)('IpInformationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.ProxyCheckerSDK({
    ...
    (0, node_test_1.test)('direct-load-ip_information', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-ip_information', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.PROXY_CHECKER_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.ProxyCheckerSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['PROXY_CHECKER_TEST_IP_INFORMATION_ENTID'];
    ...
    const client = new __1.ProxyCheckerSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=IpInformationDirect.test.js.map