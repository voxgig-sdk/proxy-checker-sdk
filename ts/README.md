# ProxyChecker TypeScript SDK



The TypeScript SDK for the ProxyChecker API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Check()` — each with a small set of operations (`load`, `create`)
...
| `tester(testopts?, sdkopts?)` | `ProxyCheckerSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `ProxyCheckerSDK.test(testopts?, sdkopts?)` | `ProxyCheckerSDK` | Create a test-mode client. |
...
| `client` | `client(): ProxyCheckerSDK` | Return the parent SDK client. |
...
Create an instance: `const ip_information = client.IpInformation()`
...
proxy-checker/
├── src/
│   ├── ProxyCheckerSDK.ts        # Main SDK class
